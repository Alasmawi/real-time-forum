...
func (db DB) SeedData() error {
	...
	insertUsers := []string{
		"INSERT INTO user (f_name, l_name, age, sex, username, email, password) VALUES ('John', 'Doe', 25, 1, 'johndoe', 'john.doe@email.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeS5vIzHQHIrEj0B6')",
		"INSERT INTO user (f_name, l_name, age, sex, username, email, password) VALUES ('Jane', 'Smith', 28, 0, 'janesmith', 'jane.smith@email.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeS5vIzHQHIrEj0B6')",
		"INSERT INTO user (f_name, l_name, age, sex, username, email, password) VALUES ('Mike', 'Johnson', 32, 1, 'mikejohnson', 'mike.johnson@email.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeS5vIzHQHIrEj0B6')",
		"INSERT INTO user (f_name, l_name, age, sex, username, email, password) VALUES ('Sarah', 'Williams', 24, 0, 'sarahwilliams', 'sarah.williams@email.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeS5vIzHQHIrEj0B6')",
		"INSERT INTO user (f_name, l_name, age, sex, username, email, password) VALUES ('David', 'Brown', 30, 1, 'davidbrown', 'david.brown@email.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeS5vIzHQHIrEj0B6')",
		"INSERT INTO user (f_name, l_name, age, sex, username, email, password) VALUES ('Emily', 'Davis', 26, 0, 'emilydavis', 'emily.davis@email.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeS5vIzHQHIrEj0B6')",
		"INSERT INTO user (f_name, l_name, age, sex, username, email, password) VALUES ('Chris', 'Wilson', 29, 1, 'chriswilson', 'chris.wilson@email.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeS5vIzHQHIrEj0B6')",
		"INSERT INTO user (f_name, l_name, age, sex, username, email, password) VALUES ('Lisa', 'Moore', 27, 0, 'lisamoore', 'lisa.moore@email.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeS5vIzHQHIrEj0B6')",
		"INSERT INTO user (f_name, l_name, age, sex, username, email, password) VALUES ('Tom', 'Taylor', 31, 1, 'tomtaylor', 'tom.taylor@email.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeS5vIzHQHIrEj0B6')",
		"INSERT INTO user (f_name, l_name, age, sex, username, email, password) VALUES ('Anna', 'Anderson', 23, 0, 'annaanderson', 'anna.anderson@email.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeS5vIzHQHIrEj0B6')",
		"INSERT INTO user (f_name, l_name, age, sex, username, email, password) VALUES ('Mark', 'Thomas', 35, 1, 'markthomas', 'mark.thomas@email.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeS5vIzHQHIrEj0B6')",
		"INSERT INTO user (f_name, l_name, age, sex, username, email, password) VALUES ('Jessica', 'Jackson', 22, 0, 'jessicajackson', 'jessica.jackson@email.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeS5vIzHQHIrEj0B6')",
		"INSERT INTO user (f_name, l_name, age, sex, username, email, password) VALUES ('Ryan', 'White', 33, 1, 'ryanwhite', 'ryan.white@email.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeS5vIzHQHIrEj0B6')",
		"INSERT INTO user (f_name, l_name, age, sex, username, email, password) VALUES ('Amanda', 'Harris', 28, 0, 'amandaharris', 'amanda.harris@email.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeS5vIzHQHIrEj0B6')",
		"INSERT INTO user (f_name, l_name, age, sex, username, email, password) VALUES ('Kevin', 'Martin', 26, 1, 'kevinmartin', 'kevin.martin@email.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeS5vIzHQHIrEj0B6')",
	}
...
func (db DB) ClearDatabase() error {
	...
	fmt.Println("🗑️  Database cleared successfully!")
	return nil
}


func (db DB) CheckIfSeeded() (bool, error) {
	var count int
...
func (db DB) SeedIfEmpty() error {
	isSeeded, err := db.CheckIfSeeded()
	if err != nil {
		return fmt.Errorf("failed to check if database is seeded: %w", err)
	}

	if isSeeded {
		fmt.Println("📊 Database already contains seed data, skipping...")
		return nil
	}
